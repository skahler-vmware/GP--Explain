package GP::Explain::StringAnonymizer;
use strict;
use Carp;
...
GP::Explain::StringAnonymizer - Class to anonymize sets of strings
...
1;    # End of GP::Explain::StringAnonymizer
