...
throws_ok
    { my $explain = GP::Explain->new( 'source_file' => 't/non-existant-file' ) }
    qr{Can't open 't/non-existant-file'},
    'Bad filename - caught ok.';

throws_ok
    { my $explain = GP::Explain->new( 'source_file' => 't/explain-file-simple.output', 'source' => 'Seq Scan on tenk1  (cost=0.00..333.00 rows=10000 width=148)' ) }
